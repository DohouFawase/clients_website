<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href=.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">BonaSport</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-header small text-uppercase">
        <span class="menu-header-text">Usercode</span>
      </li>
      ...
      <li class="menu-item">
        <a href="{{ url  ('admin/commande') }} " class="menu-link">
      ...
      <li class="menu-item">
        <a href="{{ url  ('admin/detail') }} " class="menu-link">
          ...
          <div data-i18n="Basic">Commande Details</div>
        </a>
      </li>
      ...
      <li class="menu-header small text-uppercase">
        <span class="menu-header-text">Buotique</span>
      </li>
      <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="{{ url  ('admin/categorie ') }}" class="menu-link ">
      ...
      <li class="menu-item">
        <a href="  {{ url  ('admin/post') }} " class="menu-link ">
          ...
          <div data-i18n="Misc">Article</div>
        </a>
      </li>
