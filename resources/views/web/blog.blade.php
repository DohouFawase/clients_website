    ...
    <section class="product-section px-6  mt-16">
        ...
        <section class="flex items-center bg-gray-100 lg:h-screen font-poppins dark:bg-gray-900 ">
            <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
                <div class=" max-w-6xl px-4 py-4 mx-auto  flex gap-4 sm:flex-wrap lg:flex-wrap">
    ...
    <div class="px-4 mx-auto max-w-screen-xl">
        ...
        <div class="flex justify-center flex-wrap gap-5 md:flex-wrap  lg:flex-none">
            ...
            <article class="max-w-xs">
                ...
                <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Authir</span>
                <p class="mb-4 text-gray-500 dark:text-gray-400">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
                <a href="#" class="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 dark:text-primary-500 hover:no-underline">
                    Read in 2 minutes
                </a>
